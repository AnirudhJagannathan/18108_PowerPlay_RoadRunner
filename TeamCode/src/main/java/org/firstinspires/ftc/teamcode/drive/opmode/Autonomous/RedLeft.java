...
public class RedLeft extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(tagOfInterest == null) {
            ...
            drive.accelRightGyroSlidesTurret(11.5, 0.6, 1700, 0.5, 880, 0.4);
            drive.driveStraightGyroSlidesTurret(-2.75, 0.25, 1600, 0.4, 880, 0.0);
            ...
            drive.accelRightGyroSlidesTurret(34, 0.8, 1050, 0.2, 880, 0.3);

            drive.strafeIMUJunctionLeft(false, 0.2, stageSwitchingPipelineLeftSide);

            drive.accelStraightGyroSlidesTurret(-4.1, 0.2, 2550, 0.9, 880, 0);
            drive.moveSlidesToHeightABS(2300, 0.3);
            drive.openClaw();
