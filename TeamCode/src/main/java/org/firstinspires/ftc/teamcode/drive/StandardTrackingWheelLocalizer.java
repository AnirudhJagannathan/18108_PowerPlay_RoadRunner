...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double WHEEL_RADIUS = 0.985; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    public static double LATERAL_DISTANCE = 14.46; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 3.875; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 0.9791551962;
    public static double Y_MULTIPLIER = 0.9698874881;
